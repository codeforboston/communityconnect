...
/**
 * Reducer for indicating whether resources are being fetched
 *
 * @param {object} [state] current state
 * @param {object} action the dispatched action
 *
...
export function categories(state = initialState.categories, action) {
  ...
  case types.LOAD_RESOURCE_DATA_SUCCESS: {
    ...
    for (const data of action.resource) {
      const category = data.categoryautosortscript.split(',');
...
/**
 * Reducer for filtered resources.
 *
 * @param {object} [state] current state
 * @param {object} action the dispatched action
 *
...
/**
 * Reducer for searched resources.
 *
 * @param {object} [state] current state
 * @param {object} action the dispatched action
 *
