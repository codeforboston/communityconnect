...
export const LOAD_HEAD_CATEGORIES = 'LOAD_HEAD_CATEGORIES';

export const FILTER_RESOURCE_BY_CATEGORIES = 'FILTER_RESOURCE_BY_CATEGORIES';

export const FILTER_CATEGORIES_BY_HEAD = 'FILTER_CATEGORIES_BY_HEAD';

export const FILTER_RESOURCE_BY_SEARCH = 'FILTER_RESOURCE_BY_SEARCH';

export const FILTER_RESOURCE_BY_HEAD = 'FILTER_RESOURCE_BY_HEAD';
