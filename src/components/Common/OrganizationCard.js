...
class OrganizationCard extends Component {
  static propTypes = {
    ...
    actions: PropTypes.shape({
      addSavedResource: PropTypes.func.isRequired,
    }).isRequired,
  ...
  static getDerivedStateFromProps(props) {
    ...
    validatedUrl(website) {
      ...
      const http = website.substr(0, 7);
      const https = website.substr(0, 8);
      const scheme = 'http://';
    ...
    render() {
      ...
      let distance;
      let distanceElement;
      const url = this.validatedUrl(website);
      ...
      const directionUrl = 'https://www.google.com/maps?saddr=My+Location&daddr=' +
            encodedCoordinates;
          ...
          {(facebookUrl || instagramUrl || twitterUrl) &&
                <CardFooter>
                  ...
                  <div className="list-group list-group-horizontal">
                    {facebookUrl &&
                        <a
                          className="list-group-item border-0 m-0 p-1 bg-light"
                          href={facebookUrl}
                          data-type="social"
                          ref={(node) => {
                            socialFb = node;
