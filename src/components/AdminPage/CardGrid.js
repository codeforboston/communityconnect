      ...
      <Container>
        <Row>
          <Col>
            <SearchBar
              type="text"
              // this does not appear to be used anymore in the SearchBar
        ...
        <Row>
          {
            sortedData.map((resource, index) => (
              ...
              <Col
                ...
                className="d-flex my-2 align-content-stretch justify-content-stretch"
              >
                <OrganizationCard
                  key={resource.id}
                  index={resource.id}
...
function mapStateToProps(state, ownProps) {
  const res = [];
  // Not the most efficient logic, but it works. Will have to optimize this
  // later
